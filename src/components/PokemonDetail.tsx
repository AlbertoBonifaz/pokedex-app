  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        {/* Sprites adicionales */}
        <div className="mt-8">
          <h3 className="text-2xl font-bold mb-4 text-gray-800">Sprites</h3>
            ...
            {pokemon.sprites.front_default && (
              <div className="text-center">
                <img 
                  ...
                  className="w-24 h-24 mx-auto object-contain bg-gray-100 rounded"
                />
                <p className="text-sm text-gray-600 mt-2">Frontal</p>
              </div>
            )}
            {pokemon.sprites.back_default && (
              <div className="text-center">
                <img 
                  ...
                  className="w-24 h-24 mx-auto object-contain bg-gray-100 rounded"
                />
                <p className="text-sm text-gray-600 mt-2">Trasero</p>
              </div>
            )}
            {pokemon.sprites.front_shiny && (
              <div className="text-center">
                <img 
                  ...
                  className="w-24 h-24 mx-auto object-contain bg-gray-100 rounded"
                />
                <p className="text-sm text-gray-600 mt-2">Shiny Frontal</p>
              </div>
            )}
            {pokemon.sprites.back_shiny && (
              <div className="text-center">
                <img 
                  ...
                  className="w-24 h-24 mx-auto object-contain bg-gray-100 rounded"
                />
                <p className="text-sm text-gray-600 mt-2">Shiny Trasero</p>
              </div>
            )}
          </div>
        </div>

        {/* Movimientos (solo los primeros 20) */}
        <div className="mt-8">
          <h3 className="text-2xl font-bold mb-4 text-gray-800">Movimientos</h3>
